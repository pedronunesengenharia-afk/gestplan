...
Vinte e seis migrações em `supabase/migrations/`. Leia o cabeçalho de cada arquivo
...
Apaga o banco de teste, aplica as migrações e roda as nove suítes — 248
verificações:
...
- `testes/09_afazer.sql` — 19 da lista pessoal, e da promessa de que ela é pessoal
